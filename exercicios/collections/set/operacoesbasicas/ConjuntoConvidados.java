...
public class ConjuntoConvidados {
    ...
    public void removerConvidadoPorCodigoConvite(int codigoConvite){
        ...
        for(Convidado c : convidadoSet){
            if(c.getCodigoDoConvite() == codigoConvite){
                ...
                break; //paro o laço pq dentro do Set não vai ter outro codigo igual pq o Set não permite duplicar.
            }
        }
    ...
    public static void main(String[] args) {
        ...
        conjuntoConvidados.adicionarConvidado("Charlie", 1235); //esse não vai ser adicionado pq já possui um codigo igual a esse já adicionado e o SET não permite adicionar outro com mesmo codigo.
